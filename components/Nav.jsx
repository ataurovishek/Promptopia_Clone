  ...
  return (
    <nav className="flex-between w-full mb-16 pt-3">
      <Link href="/" className="flex gap-2 flex-center">
        ...
        <Image src={Logo} alt="main logo" height={30} width={30} className="object-contain" />
      ...
      <div className="sm:flex hidden">
        ...
        {IsUserLoggedIn ?
          ...
          <div className="flex gap-3 md:gap-5">
            ...
            <Link href="/profile"><Image src={Profile} alt="Profile" width={30} height={30} /></Link>
      ...
      <div className="sm:hidden flex relative ">

        {
          IsUserLoggedIn ? (
            <div className="flex">
              <Image src={Profile} width={30} height={30} className="rounded-full" alt="profile" onClick={() => settoggleDropdown(prev => !prev)} />
              {toggleDropdown && (
